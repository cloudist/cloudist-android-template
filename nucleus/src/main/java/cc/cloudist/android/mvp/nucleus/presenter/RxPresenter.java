...
import cc.cloudist.android.mvp.nucleus.presenter.deliver.DeliverFirst;
import cc.cloudist.android.mvp.nucleus.presenter.deliver.DeliverLatestCache;
import cc.cloudist.android.mvp.nucleus.presenter.deliver.DeliverReplay;
import cc.cloudist.android.mvp.nucleus.presenter.deliver.Delivery;
...
public class RxPresenter<V> extends Presenter<V> {
     ...
     */
    public <T> void restartableFirst(int restartableId, final Func0<Observable<T>> observableFactory, final Action2<V, T> onNext) {
     ...
     */
    public <T> void restartableLatestCache(int restartableId, final Func0<Observable<T>> observableFactory, final Action2<V, T> onNext) {
     ...
     */
    public <T> void restartableReplay(int restartableId, final Func0<Observable<T>> observableFactory, final Action2<V, T> onNext) {
     ...
     */
    public <T> Action1<Delivery<V, T>> split(final Action2<V, T> onNext, @Nullable final Action2<V, Throwable> onError) {
